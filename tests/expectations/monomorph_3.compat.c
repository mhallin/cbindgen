...
typedef union {
  [FieldOffset(0)] const int32_t *data;
} Foo_i32;

typedef union {
  [FieldOffset(0)] const float *data;
} Foo_f32;

typedef union {
  [FieldOffset(0)] const Bar_f32 *data;
} Foo_Bar_f32;

typedef union {
  [FieldOffset(0)] const Foo_f32 *a;
  [FieldOffset(0)] const float *b;
} Tuple_Foo_f32_____f32;

typedef union {
  [FieldOffset(0)] const float *a;
  [FieldOffset(0)] const float *b;
} Tuple_f32__f32;
